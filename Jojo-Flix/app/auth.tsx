...
import { View, TextInput, Text, StyleSheet, TouchableOpacity, Animated, Easing, Dimensions, Keyboard, TouchableWithoutFeedback } from 'react-native';
      ...
      >
        ...
        >
          <BlurView
            ...
            style={[
              styles.card,
              keyboardOpen && { marginTop: 40, marginBottom: 10 }, // Sube el card si el teclado está abierto
            ]}
          >
